  ...
  return (
    <div className="min-h-screen bg-transparent text-white pb-12">
      ...
      <main className="mx-auto max-w-xl px-3 pt-4 space-y-4">
        ...
        {/* Banner */}
        <div className="rounded-3xl border border-emerald-500/40 bg-gradient-to-r from-[#042618] to-[#031c12] p-4 sm:p-5 shadow-xl space-y-2">
            ...
            >
              <div>
                <div className="flex items-center gap-2">
                  <span className="rounded-md bg-blue-950 px-2 py-0.5 text-[10px] font-black text-emerald-300 border border-blue-800">
                    {item.tag}
                  </span>
                  {item.isHot && (
                    <span className="rounded-md bg-amber-500/20 px-2 py-0.5 text-[10px] font-black text-amber-300 border border-amber-500/40">
                      HIGH DEMAND
                    </span>
                  )}
                </div>
                ...
                <span className="text-[11px] text-slate-400 font-semibold">{item.org}</span>
              </div>

              <div className="rounded-2xl border border-blue-900/60 bg-[#051326] p-3 text-xs space-y-1.5 text-slate-300">
                <div className="text-emerald-400 font-black">{item.benefit}</div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 py-2.5 px-4 text-xs font-black text-white hover:from-emerald-500 hover:to-teal-500 transition shadow-md"
              >
